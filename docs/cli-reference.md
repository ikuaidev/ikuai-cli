...
ikuai-cli advanced ftp create --username "user1" --password "pass" --permission rw --home-dir "/test-001"
ikuai-cli advanced ftp update <ID> --permission ro
ikuai-cli advanced ftp toggle <ID> --enabled no
ikuai-cli advanced ftp delete <ID> --yes

# HTTP
ikuai-cli advanced http list
ikuai-cli advanced http create --name "www" --port 8080 --ssl 0 --autoindex 0 --download 0 --home-dir "/test-001"
ikuai-cli advanced http update <ID> --download 1
ikuai-cli advanced http toggle <ID> --enabled no
ikuai-cli advanced http delete <ID> --yes
...
ikuai-cli advanced samba create --name "share1" --username "user1" --password "pass" --permission rw --guest yes --home-dir "/test-001"
ikuai-cli advanced samba update <ID> --permission ro
ikuai-cli advanced samba toggle <ID> --enabled no
ikuai-cli advanced samba delete <ID> --yes
